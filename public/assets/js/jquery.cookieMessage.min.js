! function (o) {
	...
	o.cookieMessage = function (n) {
		"true" != function (o) {
			...
			var n;
			n = '<div id="cookie-msg"><div class="content"><span class="msg">' + e.mainMessage + '<div class="clear"></div></span><a href="" class="btn-aceptar btn-accept">' + e.acceptButton + '</a></div></div>', o("body").append(n), o("#cookie-msg").css({
				position: "fixed",
				bottom: "0",
				width: "100%",
				"text-align": "left",
